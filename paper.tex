...
taken from the technical report by Sheldahl and Klimas
...
\end{align}
where $\alpha$ is the geometrical angle of attack and $X$, $Y$ and $Z$ are the deficiency functions, which are empirically derived, based on the flow velocity and the pitching rate, the details are found in \cite{dyachuk2013dynamic}. Indices $n$ and $n-1$ represent the current and previous time-step. A delayed angle of attack is considered due to the lag in pressure response, and it is calculated as
\begin{align}
...
\begin{figure}[h]
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CN226revolutions}}
%\resizebox{\columnwidth}{!}{\input{plot}}
\end{minipage}\hspace{2pc}%
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CT226revolutions}}
\end{minipage}
...
\begin{figure}[h]
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CNmesh}}
%\resizebox{\columnwidth}{!}{\input{plot}}
\end{minipage}\hspace{2pc}%
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CTmesh}}
\end{minipage}
...
\begin{figure}[h]
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CN226dtLEScoarse}}
%\resizebox{\columnwidth}{!}{\input{plot}}
\end{minipage}\hspace{2pc}%
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CT226dtLEScoarse}}
\end{minipage}
\caption{\label{figdtcoarse}Normal (left) and tangential (right) force coefficients varying time-step discretization for a pitching motion with a maximum amplitude of 22.6\degree\ }
\end{figure}
...
\begin{figure}[h]
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CN138}}
%\resizebox{\columnwidth}{!}{\input{plot}}
\end{minipage}\hspace{2pc}%
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CT138}}
\end{minipage}
...
\begin{figure}[h]
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CN174}}
%\resizebox{\columnwidth}{!}{\input{plot}}
\end{minipage}\hspace{2pc}%
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CT174}}
\end{minipage}
...
\begin{figure}[h]
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CN226}}
%\resizebox{\columnwidth}{!}{\input{plot}}
\end{minipage}\hspace{2pc}%
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CT226}}
\end{minipage}
...
\begin{figure}[h]
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CNRANSLES}}
%\resizebox{\columnwidth}{!}{\input{plot}}
\end{minipage}\hspace{2pc}%
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CTRANSLES}}
\end{minipage}
\caption{\label{RANSLES}Normal (left) and tangential (right) force coefficients for different turbulence models, pitching motion with a maximum amplitude of 22.6\degree\ }
\end{figure}
...
\begin{figure}[h]
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CNAMP174corrections}}
%\resizebox{\columnwidth}{!}{\input{plot}}
\end{minipage}\hspace{2pc}%
\begin{minipage}{18pc}
\resizebox{\columnwidth}{!}{\input{./figures/CTAMP174corrections}}
\end{minipage}
\caption{\label{AMP174corrections}Normal (left) and tangential (right) force coefficients with and without unsteady effects correction, pitching motion with a maximum amplitude of 17.4\degree\ }
\end{figure}
...
studied. Moreover, the model has been tested for a wide range of pitching
...
accurate for the tested pitching blade motions, which makes it suitable for
